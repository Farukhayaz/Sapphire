...
import { West } from '../components/data'
import { Sticker } from '../components/data'
import { useState } from 'react'

export default function Westfun() {
  function changeIndex(e, i) {
    e.target.style.backgroundImage = `url(${West[i].hoverimg})`
  }
  function returnIndex(e, i) {
    e.target.style.backgroundImage = `url(${West[i].img})`
  }
