...
import { Accessories } from '../components/data'
import { Sticker } from '../components/data'
import { useState } from 'react'

export default function Accessoriesfun() {
  function changeIndex(e, i) {
    e.target.style.backgroundImage = `url(${Accessories[i].hoverimg})`
  }
  function returnIndex(e, i) {
    e.target.style.backgroundImage = `url(${Accessories[i].img})`
  }
