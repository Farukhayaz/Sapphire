...
import { Man } from '../components/data'
import { Sticker } from '../components/data'
import { useState } from 'react'

export default function Manfun() {
  function changeIndex(e, i) {
    e.target.style.backgroundImage = `url(${Man[i].hoverimg})`
  }
  function returnIndex(e, i) {
    e.target.style.backgroundImage = `url(${Man[i].img})`
  }
  return (
    <>
